...
import { Client, Project, Package, AddOn, Transaction, Profile, Card, FinancialPocket, ClientStatus, ProjectStatus, PaymentStatus, TransactionType, PromoCode } from '../types';
...
const PublicBookingForm: React.FC<PublicBookingFormProps> = ({ 
    setClients, setProjects, packages, addOns, setTransactions, userProfile, cards, setCards, pockets, setPockets, promoCodes, setPromoCodes, showNotification
}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const newClient: Client = {
            ...
            since: new Date().toISOString().split('T')[0], status: ClientStatus.ACTIVE, lastContact: new Date().toISOString(),
        ...
        const newProject: Project = {
            ...
            date: formData.date, location: formData.location, progress: 0, status: ProjectStatus.CONFIRMED,
